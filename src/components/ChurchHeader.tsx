...
const ChurchHeader = () => {
  ...
  return <div className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 min-h-[85vh] sm:min-h-[80vh] lg:min-h-[75vh] flex items-center">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-12 sm:bottom-16 right-4 sm:right-8 w-64 sm:w-80 h-64 sm:h-80 bg-purple-200/25 rounded-full blur-3xl animate-float" style={{
        animationDelay: '2s'
      }}></div>
        ...
        <div className="absolute bottom-24 sm:bottom-32 left-12 sm:left-16 animate-pulse" style={{
        animationDelay: '1s'
      }}>
          <Star className="h-2 sm:h-3 w-2 sm:w-3 text-purple-400/60" />
        </div>
        <div className="absolute top-32 sm:top-40 left-1/4 sm:left-1/3 animate-pulse" style={{
        animationDelay: '3s'
      }}>
      ...
      <div className="absolute top-4 sm:top-6 right-4 sm:right-6 z-10">
        {user ? <UserMenu /> : <Button variant="outline" onClick={() => navigate('/auth')} className="bg-white/90 backdrop-blur-sm border-blue-200/40 hover:bg-white/95 transition-all duration-300 font-inter text-sm sm:text-base px-3 sm:px-4 py-2">
            Entrar
          </Button>}
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 w-full">
        <div className="text-center">
          ...
          <div className="mb-6 sm:mb-8 flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="flex-shrink-0">
              <div className="relative">
                ...
                <img src="/lovable-uploads/a989c536-6a58-44f9-a982-3a6b3847a288.png" alt="Igreja Batista Missionária Ministério Monte Hebrom" className="relative h-24 w-24 sm:h-28 sm:w-28 md:h-36 md:w-36 lg:h-40 lg:w-40 object-contain drop-shadow-2xl transition-transform duration-500 hover:scale-105" />
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-6 sm:mb-8 px-4 sm:px-0">
            <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 font-inter font-semibold px-6 sm:px-8 py-3 text-sm sm:text-base" onClick={() => navigate('/comunicacao')}>
              💬 Conhecer Nossa Comunidade
              <ArrowRight className="ml-2 h-4 sm:h-5 w-4 sm:w-5" />
            </Button>
            <Button size="lg" variant="outline" className="w-full sm:w-auto border-2 border-blue-200 hover:border-blue-300 bg-white/80 hover:bg-white/90 text-blue-800 backdrop-blur-sm transition-all duration-300 font-inter font-semibold px-6 sm:px-8 py-3 text-sm sm:text-base" onClick={() => navigate('/devocional')}>
              📖 Acessar Devocionais
            </Button>
          </div>
        </div>
